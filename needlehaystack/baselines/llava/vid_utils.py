...
def load_video(
    ...
    if video_decode_backend == 'pytorchvideo':
        ...
        # # Create a figure
        # plt.figure(figsize=(20, max(20, T//5)))
        # # Number of frames to display (you can adjust this number)
        # # num_display_frames = min(16, T)
        # num_display_frames = T
        # for i in range(num_display_frames):
        #     plt.subplot(math.ceil(num_display_frames/8), 8, i + 1)  # Assuming a 4x4 grid for visualization
        #     frame = video_data[i]
        #     plt.imshow(frame)
        #     plt.axis('off')
        # plt.savefig("sampled_frame.png")
