...
import torch
from needlehaystack.baselines.longva.model import *
from needlehaystack.baselines.longva.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from needlehaystack.baselines.longva.utils import rank0_print
    ...
    if "llava" in model_name.lower()  or "longva" in model_name.lower() or is_multimodal:
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "mixtral" in model_name.lower():
                ...
                from needlehaystack.baselines.longva.model.language_model.llava_qwen import LlavaQwenConfig
